...
///////////////////////////////////////////////////////////////////////////////
		...
		f_MaxVal_1 = CH1MaxVal*3.3/4096*3;
		printf("tv1.txt=\"%.3fV\"\xff\xff\xff",f_MaxVal_1);
...
///////////////////////////////////////////////////////////////////////////////
		for(i = 0; i < 100; i++)
		{
			if(AD_Value[i][1] < CH2MaxVal)
			{
				CH2MaxVal = CH2MaxVal;
			}
			else
			{
				CH2MaxVal = AD_Value[i][1];
			}
		}
		
		f_MaxVal_2 = CH2MaxVal*3.3/4095*3;
		printf("tv2.txt=\"%.3fV\"\xff\xff\xff",f_MaxVal_2);
		if( CH2MaxVal > 2069)
		{
